import { riotInstance } from './constants';

export let getAccount = async (summonerName) => {
...
export let getMatch = async (accountId, summonerId, amountOfGames) => {
...
export let getMatchData = async(gameId, summonerId, champId) => {
